                        ...
                        <div style="background-image: url(../../imagenes/bb.jpg)"
                            ...
                            <div class=" px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                <button type="button" @click="modal=false"
                                    class="inline-flex w-full justify-center rounded-md border border-transparent bg-amber-400 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm">aceptar</button>
                               <!-- <button type="button"
